 ...
 * @author ASUS
 */
public class IDCCompleteConnectivity extends Element implements PluginWebSupport {
    ...
    public void webService(HttpServletRequest hsr, HttpServletResponse hsr1) throws ServletException, IOException {
        IDCCompleteConnectivityDao dao = new IDCCompleteConnectivityDao();
        ResponseAPI responseTemplete = new ResponseAPI();

        LogUtil.info(this.getClass().getName(), "############## START PROCESS IDC COMPLETE CONNECTIVITY ###############");
...
//                String locationName = data_obj.get("locationName").toString();
//                String uId = data_obj.get("uId").toString();

                try {
//                    dao.validateActivationPower(wonum);
                    String message = dao.validateIDCCompConn(wonum);
//
