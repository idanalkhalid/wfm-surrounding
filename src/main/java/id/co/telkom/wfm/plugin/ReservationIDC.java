...
import id.co.telkom.wfm.plugin.dao.ReservationIDCDao;
 ...
 * @author ASUS
 */
public class ReservationIDC extends Element implements PluginWebSupport {

    String pluginName = "Telkom New WFM - Reservation IDC - Web Service";
    ...
    public void webService(HttpServletRequest hsr, HttpServletResponse hsr1) throws ServletException, IOException {
        ReservationIDCDao dao = new ReservationIDCDao();
        ...
        if ("POST".equals(hsr.getMethod())) {
            try {
                ...
                try {
                    String message = dao.validateCNDC(wonum);

                    if (message.equals("Gagal Reservation") || message.equals("This product is not CNDC product")) {
